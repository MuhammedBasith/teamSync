...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "TeamSync transformed how we manage our distributed team. Setting up teams and inviting members is incredibly simple, and the activity logs give us complete visibility.",
      name: "Jamie Marshall",
    ...
    {
      quote:
        "We needed a straightforward way to organize our growing startup. TeamSync's role management and bulk CSV import saved us hours of manual work. It just works.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "Finally, a team management tool that doesn't overwhelm you with features you don't need. TeamSync keeps everything organized, clear, and under control.",
      name: "Marcus Rodriguez",
      company: "Operations Lead, InnovateCorp",
      image:
